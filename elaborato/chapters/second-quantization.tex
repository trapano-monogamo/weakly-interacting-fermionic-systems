...
particles. \textcolor{red}{Check citation} The majority of the definitions and theorems
presented in this chapter are taken, and often reworked, from professor Solovej's lectures
notes on many body quantum theory [\cite{SolNotes}], \textcolor{red}{and we will specify
the page number for the important proofs they provide}.
...
(+) for \textit{bosons} and (-) for \textit{fermions}. Generalizing to the case of $N$
identical particles (of the same statistics) means defining physical states as those that
...
\textcolor{red}{We only care about the basic results about quadratic Hamiltonians from Solovej's
notes. Easy stuff, CHOP CHOP weather boy.}
