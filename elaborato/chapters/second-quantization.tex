...
and often reworked, from professor Solovej's lectures notes on many body quantum theory
\cite{SolNotes}. We will specify the page number for the proofs that are taken directly from
Solvej's notes, while the proofs that do not have a page number are those that are not found
...
\begin{remark}
	...
	boundary conditions. The stability of free particles is essential, as will become clear in
	the third chapter.
\end{remark}
