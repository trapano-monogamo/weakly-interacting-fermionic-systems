...
\begin{lemma}
	If $X$ is a dense closed subspace of the Hilbert space $\mathcal{H}$, it is always possible
	to choose a basis $\{u_n:n\in\mathbb{N}\}$ for $\mathcal{H}$ composed only of elements of
	$X$.
\end{lemma}
\begin{proof}
...
\end{theorem}
\begin{proof}
	\textcolor{red}{AAAAAAAAAAAAAAHHHHHHHHHHHHH.}
\end{proof}
