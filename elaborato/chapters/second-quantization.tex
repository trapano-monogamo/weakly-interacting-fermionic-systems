...
\end{align}
These are unitary by construction, and showing that they are also projections only involves
rewriting the sum over two sets of permutations as a single one to get that $P_\pm^2 = P_\pm$.
...
The last statement is the content of Pauli's exclusion principle.
...
in the next chapter, and it motivates tools we will need to introduce. The content of this
important theorem is, concretely, that all the expectations we are interested in reduce to
products of the 2-point function. We first look at the case of pure states and then move onto
Gibbs states.
